...
hello_beforev2:     file format elf64-x86-64
...
0000000000001050 <deregister_tm_clones>:
    ...
    1063:	48 8b 05 5e 2f 00 00 	mov    0x2f5e(%rip),%rax        # 3fc8 <_ITM_deregisterTMCloneTable>
...
0000000000001080 <register_tm_clones>:
    ...
    10a4:	48 8b 05 2d 2f 00 00 	mov    0x2f2d(%rip),%rax        # 3fd8 <_ITM_registerTMCloneTable>
...
00000000000010c0 <__do_global_dtors_aux>:
    ...
    10fd:	00 00 00 
    1100:	c3                   	ret
    1101:	0f 1f 40 00          	nopl   0x0(%rax)
    1105:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
    110c:	00 00 00 00 
...
0000000000001119 <main>: --> For now, starting at basics, just focus on this main function for now. This is the int main(void) we wrote. 
--> In case of hello_world.disassembly.md, we just added printf(...) and there it calls puts... See there to feel the actual difference...
--> I think I should not be an expert now to read an assembly. Just good enough to notice the difference.
    1119:	55                   	push   %rbp
