...
0000000000001020 <printf@plt-0x10>:  Ah : my optimisation did not happen? why is that so? why is the compiler calling printf still? maybe we need to explicitly state clang to -O2 the optimisation? Lets try that way........ 
